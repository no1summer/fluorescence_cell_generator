classdef Rescale_Marker_Levels <CellGen_Marker_Operation
  ...
  methods
    ...
    function obj=Rescale_Marker_Levels()
      obj.min_intensity=Parameter('Min',1,CellGen_Class_Type.number,...
        [0,1],'Minimum Intensity After Rescaling');
      obj.max_intensity=Parameter('Max',1,CellGen_Class_Type.number,...
