classdef Perlin_Texture <CellGen_Marker_Operation
  ...
  methods
    ...
    function obj=Perlin_Texture()
      obj.add_or_multiply=Parameter('Additive or Multiplicative','Multiply',CellGen_Class_Type.list,...
        {'Add','Multiply'},'Should the noise be additive or multiplicative?');
      obj.amplitude=Parameter('Noise Amplitude',0.5,CellGen_Class_Type.number,...
        [0,Inf],'Amplitude of Noise [0-low, 1-High]');
      obj.length_scale=Parameter('Length Scale',2,CellGen_Class_Type.number,...
        [2,6],'Scale of Noise [2 - long length scale, 5-short]]');
      obj.frequency_falloff=Parameter('Frequency Falloff',0.5,CellGen_Class_Type.number,...
        [0,1],'Frequency Falloff [0 (Only lowest frequency) - 1 (All frequencies)]]');
      obj.noise_type=Parameter('Noise Type','Standard 1/f',CellGen_Class_Type.list,...
