classdef Nucleus_Model <CellGen_Object_Model
  ...
  methods
    ...
    function obj=Nucleus_Model()
      obj.radius=Parameter('Nuclear Radius',15,CellGen_Class_Type.number,...
    ...
    % of type CellGen_Object, and should be passed to the function by a 
