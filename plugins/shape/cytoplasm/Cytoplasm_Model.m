classdef Cytoplasm_Model <CellGen_Object_Model
  ...
  methods
    ...
    function obj=Cytoplasm_Model()
      obj.radius=Parameter('Cell Radius',15,CellGen_Class_Type.number,...
      ...
      obj.randomness=Parameter('Extent of Variation',0.1,CellGen_Class_Type.number,...
    ...
    % CellGen_Object, and should be passed to the function by a user
