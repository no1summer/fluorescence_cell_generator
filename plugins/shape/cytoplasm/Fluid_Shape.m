classdef Fluid_Shape <CellGen_Object_Model
  ...
  methods
    ...
    function obj=Fluid_Shape()
      obj.radius=Parameter('Cell Radius',30,CellGen_Class_Type.number,...
        [0,Inf],'Average Cell Radius');
      obj.eccentricity=Parameter('Cell Eccentricity',0.5,CellGen_Class_Type.number,...
        [0,1],'Measure of Non-Uniformity: 1=spherical, 0=straight line');
      obj.randomness=Parameter('Randomness',0.1,CellGen_Class_Type.number,...
