classdef Nearby_Placement <CellGen_Placement_Model
  ...
  %%Models for placements are classes of type CellGen_Placement_Model,
  ...
  %%(see CellGen_Model, Parameter), and the user settable parameters
